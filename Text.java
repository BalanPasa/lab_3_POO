...
public class Text 
{
    ...
    public int countSentences() 
    {
        ...
        {
            if (text.charAt(i) == '.' || text.charAt(i) == '?' || text.charAt(i) == '!') sentence++;
        }
        return sentence;
    }
    ...
    public int countLetters() 
    {
        ...
        {
            if (Character.isLetter(text.charAt(i))) letter++;
        }
        return letter;
    }
    ...
    public int countVowels() 
    {
        for (int i = 0; i < this.textArray.length; i++) 
        {
            if (text.charAt(i) == 'A' || text.charAt(i) == 'a' || text.charAt(i) == 'E' || text.charAt(i) == 'e' || text.charAt(i) == 'I' || text.charAt(i) == 'i' || text.charAt(i) == 'O' || text.charAt(i) == 'o' || text.charAt(i) == 'U' || text.charAt(i) == 'u')  vowel++;
        }
        return vowel;
    }

    public int countConsonants() {return (countLetters() - countVowels()) / 2;}
